...
const stages = [
  {
    ...
    description: "Ученик фиксирует наблюдаемое физическое явление и формулирует проблему проекта.",
  ...
  {
    title: "Формулировка цели и гипотезы",
    description: "Определяются ожидаемый результат и предположение, которое можно проверить.",
  ...
  },
  {
    ...
    description: "Составляется план действий, список ресурсов, критерии результата и сроки.",
  ...
  },
  {
    ...
    description: "Ученик изучает источники, выделяет ключевые понятия и проверяет достоверность.",
  ...
  },
  {
    ...
    tasks: {
      ...
      ai: "Помогает подготовить таблицы, объяснить возможные погрешности и варианты фиксации данных.",
